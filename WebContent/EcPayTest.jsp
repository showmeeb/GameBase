...
<body>
<form id="idFormAioCheckOut" method="post" action="EcPayServlet">
    ...
    <label class="col-xs-12">時間 (MerchantTradeDate):
        <input type="text" name="MerchantTradeDate" value="2020/06/30 00:00:00" class="form-control"/>
        yyyy/MM/dd HH:mm:ss
    </label>
    ...
    <label class="col-xs-12">回傳網址 (ReturnURL):
        <input type="text" name="ReturnURL" value="https://a7612c5a.ngrok.io/EcpayTest/successServlet" class="form-control"/>
    </label>
