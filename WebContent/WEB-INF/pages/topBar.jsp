		...
		<div class="col-md-2 column">
			<div class="dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					...
					<!-- original -->
					<a class="dropdown-item">--This line down is Original--</a> <a
						class="dropdown-item" href="<c:url value="/gotologin"/>">登入</a> <a
						class="dropdown-item" href="<c:url value="/gotoregister"/>">註冊</a>
					<a class="dropdown-item" href="<c:url value="/logout"/>">登出</a> <a
						class="dropdown-item"
