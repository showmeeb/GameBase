...
<body>
	...
	<span id="order" role="button" tabindex="0" aria-pressed="true"><img
		src="https://i.imgur.com/MflYSUa.jpg" class="myimg"></span>
	<span id="shopcart" role="button" tabindex="0" aria-pressed="true"><img
		src="https://i.imgur.com/fzG8Ocj.png" class="myimg"></span>
...
<jsp:include page="footer.jsp" />
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$(document.body).on("shown.bs.modal", '#d1', function(e) {
				console.log('顯示視窗前呼叫');
			});
			$('body').on('hidden.bs.modal', 'body', function(e) {
				alert("asd");
			});
