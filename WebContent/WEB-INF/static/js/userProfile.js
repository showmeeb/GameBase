	$(document).ready(function() {
		...
		function checkPhone(){
			...
			if(!testPhone){
				return document.getElementById('phoneErr').innerHTML = '請輸入正確號碼';
				return false;
			}else{
				return document.getElementById('phoneErr').innerHTML = 'ok';
				return true;
			}
		}
		...
		function checkAge(){
			...
			if(isNaN(age)||age>100||age<10){
				return document.getElementById('ageErr').innerHTML = '請輸入介於10~100間的數字';
				return false;
			}else{
				return document.getElementById('ageErr').innerHTML = 'ok';
				return true;
			}
		}