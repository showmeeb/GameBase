...
public class MsgBoardDAO implements IMsgBoardDAO {
	...
	public MsgBoard insertMsg(MsgBoard mb) {
		List<MsgBoard> query = sessionFactory.getCurrentSession()
				.createQuery("from MsgBoard where "
				...
				.setParameter(1, mb.getParentId()).setParameter(2, mb.getUserId())
				.setParameter(3, mb.getBoardLocation()).setParameter(4, mb.getBoardTitle())
				.setParameter(5, mb.getContent()).setParameter(6, mb.getRecordTime())
	...
	public List<MsgBoard> queryParentMsg(MsgBoard mb) {
		Query<MsgBoard> query = sessionFactory.getCurrentSession()
				.createQuery("from MsgBoard where boardLocation=:boardLocation and parentId=:parentId", MsgBoard.class)
				.setParameter("boardLocation", mb.getBoardLocation()).setParameter("parentId", 0);
	...
	public List<MsgBoard> queryArticlesByParentId(int parentId) {
		Query<MsgBoard> query = sessionFactory.getCurrentSession()
				.createQuery("from MsgBoard where parentId=:parentId", MsgBoard.class)
