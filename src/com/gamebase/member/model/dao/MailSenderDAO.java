...
//				+registerId+"<br/><h3><a href='" + url + "'>"+url+"</a></h3>"+"<br/>如果您認為這是垃圾郵件，請忽略此郵件。";
	...
	public Map<String,String> password(UserData userdata){
		Map<String,String> map = new HashMap<String,String>();

		String content = "GameBase會員:"+userdata.getAccount()+"您好,<br>您的密碼已經重置為: "+userdata.getPassword()+"<br>請以此密碼登入後，重新設定您的密碼。";

		MailInfo mailInfo = new MailInfo();
		mailInfo.setMailSmtpHost("smtp.gmail.com");
		mailInfo.setFromAddress("z0983177929@gmail.com");
		mailInfo.setToAddress(userdata.getEmail());
		mailInfo.setMailSmtpPort("587");
		mailInfo.setUserName("z0983177929@gmail.com");
		mailInfo.setPassword("K98david");
		mailInfo.setValidate(true);
